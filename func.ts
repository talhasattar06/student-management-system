...
import { balance, StudentManagement } from "./class.js";

// Student Finder
async function findStudentAndHandleErrors(id: number, studentManager: StudentManagement) {
    if (isNaN(id)) {
...
// Student Enrollment
export async function enrollStudent(studentManager: StudentManagement) {
...
// Course Enrollment
export async function courseEnroll(studentManager: StudentManagement) {
...
// Student Status
export async function studentStatus(studentManager: StudentManagement) {
...
// Student Balance
export async function studentBalance(studentManager: StudentManagement) {
