...
export class Student {
    ...
    age;
    courses;
    constructor(firstName, lastName, fatherName, age) {
...
export class StudentManagement {
    ...
    add_student(firstName, lastName, fatherName, age) {
    ...
    course_enroll_student(studentId, course, amount) {
